# Selección de Nacionalidad Activa en Conversaciones

Este documento detalla la especificación técnica, la estructura de base de datos en Supabase, los proveedores de estado reactivos en Riverpod y los componentes visuales implementados para permitir a los usuarios alternar el idioma/nacionalidad activo dentro de cada chat de Lingiux mediante un carrusel horizontal.

---

## 🏗️ 1. Arquitectura y Sincronización en Tiempo Real

El sistema permite cambiar la bandera/nacionalidad de la conversación de forma persistente y sincronizada. Si el Usuario A cambia el idioma en el chat a Francés (`fr`), el Usuario B verá instantáneamente la bandera de Francia en su barra de navegación superior.
...
### [NUEVO] [seleccion_nacionalidad_activa_en_conversacion.md](file:///c:/Users/sebas/OneDrive/Escritorio/Lingiux/lingiux_app/resources/mds_relevantes/seleccion_nacionalidad_activa_en_conversacion.md)
...
*   Implementación de los componentes de interfaz, carrusel horizontal deslizable, gestores de gestos y actualización reactiva desde `chatsProvider`.
